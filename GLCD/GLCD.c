...
/******************************************************************************
* Function Name  : LCD_DrawRectFilled
* Description    : Draws a filled rectangle
* Input          : - Xpos: start xpos (up-left)
*                  - Ypos: start ypos (up-left)
...
void LCD_DrawRectFilled(uint16_t Xpos, uint16_t Ypos, int b, int h, uint16_t color) {
	int i;
	for(i=0; i<h; i++){
		LCD_DrawLine(Xpos, Ypos+i, Xpos+b-1, Ypos+i, color);
	}
}

/******************************************************************************
* Function Name  : LCD_DrawRectBorder
* Description    : Draws an empty rectangle with border of given color
* Input          : - Xpos: start xpos (up-left)
*                  - Ypos: start ypos (up-left)
*				   - color: color of square
*				   - h: height
...
void LCD_DrawRectBorder(uint16_t Xpos, uint16_t Ypos, int b, int h, uint16_t color) {
	LCD_DrawLine(Xpos,Ypos,Xpos+b-1,Ypos,color);

	LCD_DrawLine(Xpos,Ypos,Xpos,Ypos+h-1,color);

	LCD_DrawLine(Xpos+b-1,Ypos,Xpos+b-1,Ypos+h-1,color);

	LCD_DrawLine(Xpos,Ypos+h-1,Xpos+b-1,Ypos+h-1,color);
}

/******************************************************************************
* Function Name  : GUIText_X_Centered
* Description    : Writes input text along center Y axis, on a specified Ypos value
* Input          : - Ypos: ������ 
*				   				 - str: �ַ���
*				   				 - charColor: �ַ���ɫ   
*				   				 - bkColor: ������ɫ 
...
void GUIText_X_Center(uint16_t Ypos, uint8_t *str, uint16_t Color, uint16_t bkColor){
	GUI_Text(GUIText_CenterCX(str), Ypos, str, Color, bkColor);
}

uint8_t GUIText_CenterCX(uint8_t *str){
	return (MAX_X - strlen((char*) str)*8)/2;
}
